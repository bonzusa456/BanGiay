<?php 
	...
	if(isset($_POST["delivery"])){	//ghi du lieu xuong database
		...
		foreach($_SESSION["cart_item"] as $k=>$v){
			...
			$totalprice=($discount[$k]["price"])*$_SESSION["cart_item"][$k]["quanlity"];
			$queryCT="INSERT INTO chitiethoadon(MA_HD, MA_SP, SO_LUONG, DON_GIA, THANH_TIEN)";
			$queryCT.=" VALUES('" .$IDnew. "', '" .$k. "', '" .$_SESSION["cart_item"][$k]["quanlity"]. "', '" 
