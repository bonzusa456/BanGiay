...
<div class="ads-grid py-sm-5 py-4 all-product " style="margin-left: 30px;">
        <div class="title_search " style="margin-top:100px;">
            <span class="keyword_search">TÌM KIẾM THEO TỪ KHOÁ:  <strong><?php echo $tukhoa ?></strong></span>
        </div>
        <h4 class="no_result_search" ><?php echo $title_result ?> </h4>
        <div class="row">
        	<script>
				getresult("getresult_search.php<?php echo "?search_product=$tukhoa" ?>");
			</script>
